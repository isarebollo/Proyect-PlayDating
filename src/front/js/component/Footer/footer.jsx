          ...
          <div className="row">
            <div className="col-md-8 col-sm-6 col-xs-12">
              <p className="copyright-text">Copyright &copy; 2023 All Rights Reserved by{" "}
                <a >Isabel Rebollo Corraliza</a>.
              </p>
            </div>
            {/* ..........................................añadir links ............................ */}
            <div className="col-md-4 col-sm-6 col-xs-12">
              <ul className="social-icons">
                <li><a className="github" target="_blank" href="https://github.com/isarebollo/Proyect-PlayDating/"><BsGithub></BsGithub></a></li>
                <li><a className="linkedin" target="_blank" href="https://www.linkedin.com/in/isabelrebollo/"><BsLinkedin></BsLinkedin></a></li>
              </ul>
            </div>
          </div>
        </div>
